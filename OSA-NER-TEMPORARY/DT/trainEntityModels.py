...
def train_ner(nlp, train_data, output_dir, entity_types):
...
#    print(ent_types)
    ner = train_ner(nlp, train_data, output_directory, entity_types=['AREA', 'ADDRESS'])
    save_model(ner, output_directory)
