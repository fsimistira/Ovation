...
def main():
    ...
    # GloVe
    twitter_embeddings, word2index = utils.read_glove_embeddings(tweets_train + tweets_test)
    ...
    network.train_multitask_net_with_split(mtl_network, x_train_samples, y_train_samples, epochs=150)
